...
import 'package:flutter_revision/widgets/home_widgets/catalog_header.dart';
import 'package:flutter_revision/widgets/home_widgets/catalog_list.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      floatingActionButton: VxBuilder(
        ...
        ).badge(color:Vx.gray200,size:22,count: _cart.items.length,textStyle: TextStyle(color: Colors.black, fontWeight:FontWeight.bold)),
      ),
    body: SafeArea(
          child: Container(
            padding: Vx.m32,
